...
import { PingOptions as VanillaPingOptions, OldPingResult, NewPingResult } from 'minecraft-protocol'
...
declare module 'minecraft-protocol-forge' {
  ...
  export interface FML3PingResultOverride extends FML3PingResult {
    forgeData: {
      channels: FML3Channel[]
      mods: FML3Mod[]
    }
